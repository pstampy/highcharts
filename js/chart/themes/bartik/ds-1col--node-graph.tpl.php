...
drupal_add_js(path_to_theme().'/FusionCharts.HC.js');
drupal_add_js(path_to_theme().'/Column3D.swf');
drupal_add_js(path_to_theme().'/FusionCharts.jqueryplugin.js');
drupal_add_js(path_to_theme().'/FusionCharts.js');
drupal_add_js(path_to_theme().'/FusionChartsExportComponent.js');
drupal_add_js(path_to_theme().'/jquery.min.js');
...
<?php
echo t('<h1>My First chart using FusionCharts XT<h1>');       ?>
